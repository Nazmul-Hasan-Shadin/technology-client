...
const ProductDetails = () => {
    ...
    const handleAddToCart= ()=>{
        ...
        fetch('http://localhost:5000/carts',{
            ...
            body: JSON.stringify({
                productName, brand,type,rating,price,description,imageUrl,_id
            })
        })
        .then(res=>res.json())
        .then(data=>{
            if (data.acknowledged) {
                toast.success('Successfully adeed to cart!')
            }
        })
        .catch(err=>{
...
<section className="text-gray-700 body-font overflow-hidden bg-white">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={imageUrl}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">BRAND NAME: {brand}</h2>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-red-600"> Price : {price} </span>
