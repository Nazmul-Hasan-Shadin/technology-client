...
const BrandBanner = ({images}) => {
    return (
        <div className='w-[360px] lg:w-2/3 flex  '>
        <Swiper
  pagination={{
    type: 'fraction',
  }}
...
>
{
     images.map(singleImg=><>
          ...
          <img className='relative w-36  md:w-[355px]  md:h-[400px]  ' src={singleImg} alt="" />
              ...
              top-3 lg:top-24 w-96 lg:w-full left-[104px] md:left-80 lg:space-y-4'> 
  ...
  <div className='relative left-60 w-full hidden md:block'>
